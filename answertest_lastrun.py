...
expName = u'answertest'  # from the Builder filename that created this script
...
thisExp = data.ExperimentHandler(name=expName, version='',
    ...
    originPath=u'C:\\Users\\Gianluca\\Documents\\projects\\01_NoisyGVS_visual_motion\\01_code\\answertest.psyexp',
...
dots = visual.DotStim(
    win=win, name='dots',
    nDots=1000, dotSize=2,
    speed=3, dir=0.0, coherence=1.0,
...
for thisTrial in trials:
    ...
    while continueRoutine:
        ...
        if key_resp_2.status == STARTED and frameN >= (key_resp_2.frameNStart + 360):
